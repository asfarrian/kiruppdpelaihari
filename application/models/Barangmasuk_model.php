<?php
    ...
    {
        if ($id_barang==''){
            return $this->db->query("SELECT tb_inventaris.id_barang, tb_inventaris.kode_barang,tb_inventaris.nama_barang,tb_inventaris.merk,tb_inventaris.nomor_registrasi,tb_inventaris.ukuran,tb_inventaris.bahan,tb_inventaris.tahun_pembelian,tb_inventaris.asal_usul,tb_inventaris.kondisi,tb_inventaris.harga,tb_inventaris.keterangan,tb_mutasimasuk.id_barangmasuk,tb_mutasimasuk.id_barangmasuk FROM tb_mutasimasuk join tb_inventaris ON tb_mutasimasuk.id_barang=tb_inventaris.id_barang")->result_array();
        }else {
            return $this->db->query("SELECT tb_inventaris.id_barang, tb_inventaris.kode_barang,tb_inventaris.nama_barang,tb_inventaris.merk,tb_inventaris.nomor_registrasi,tb_inventaris.ukuran,tb_inventaris.bahan,tb_inventaris.tahun_pembelian,tb_inventaris.asal_usul,tb_inventaris.kondisi,tb_inventaris.harga,tb_inventaris.keterangan,tb_mutasimasuk.id_barangmasuk,tb_mutasimasuk.id_barangmasuk FROM tb_mutasimasuk join tb_inventaris ON tb_mutasimasuk.id_barang=tb_inventaris.id_barang where id_barang='$id_barang'")->row_array();
        }
    }
